...
public class NameEncodedBlockParseTest {
    ...
    public void test1() throws IOException {
        ...
        assertEquals(new HashValue(0xb7, 0x3a, 0xaf, 0x87, 0x48, 0xcf, 0xe4,
                0x8e, 0xdd, 0x27, 0x0d, 0x01, 0x51, 0x7e, 0xf5, 0x55, 0x6d,
                0x03, 0x24, 0x2a, 0xf4, 0x1c, 0xa5, 0x82, 0x08, 0xc8, 0x40,
                0xc8, 0x2e, 0x78, 0x65, 0x1a), e.getHash());
    ...
    public void test2() throws IOException {
        ...
        assertEquals(new HashValue(0xc8, 0x36, 0x28, 0x75, 0x34, 0x63, 0x14,
                0x54, 0x6f, 0x8f, 0x50, 0x26, 0xfc, 0xd4, 0x77, 0x38), e
                .getHash());
        assertEquals(b.getBody(), e.getBody());
    }
