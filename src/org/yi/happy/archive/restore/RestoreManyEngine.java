 ...
 * 
 * <pre>
 * {@link RestoreManyEngine} r = new {@link RestoreManyEngine}(key);
 * 
 * r.{@link #start()};
 ...
 * 
 * <pre>
 * {@link RestoreManyEngine} r = new {@link RestoreManyEngine}();
 * r.add("1", key1);
 * r.add("2", key2);
 * 
 * r.{@link #start()};
 ...
 * </pre>
 */
public class RestoreManyEngine {
     ...
     * The jobs.
     */
    private List<Job> jobs = new ArrayList<RestoreManyEngine.Job>();
     ...
     */
    public RestoreManyEngine(String name, RestoreWork work) {
        this();
     ...
     */
    public RestoreManyEngine(String name, FullKey key) {
     ...
     *            the key to put together.
     */
    public RestoreManyEngine(FullKey key) {
        this(null, key);
    }
